...
activities = {
    ...
    "Soccer Club": {
        "description": "Team soccer drills and friendly matches",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, script reading and performances",
    ...
    "Debate Team": {
        "description": "Argument preparation and interschool debate competitions",
